...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-13 13:41`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d278b7a6-5ada-4dde-9a90-4aa523a8ecbf.git
$ cd d278b7a6-5ada-4dde-9a90-4aa523a8ecbf
```
